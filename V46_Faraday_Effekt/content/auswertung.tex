...
Vergleicht man die Ausgleichsfunktion \autoref{eqn:fit_lam2} mit \autoref{eqn:theta} und identifiziert den Fit-Parameter $a$, so folgt für die effektive Masse $m^*$%REF
\begin{align}
